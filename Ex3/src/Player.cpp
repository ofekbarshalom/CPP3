...
namespace coup {
    ...
    // Constructor: initializes player state and registers with game
    ...
    void Player::setArrestBlocked(bool val) { arrestBlocked = val; }
    ...
    // Gather, tax, bribe, arrest, sanction, coup actions
    void Player::gather() {
    ...
    void Player::arrest(Player& target) {
        ...
        // Handle role-specific arrest effects
    ...
    // Default undo behavior — throws unless overridden
