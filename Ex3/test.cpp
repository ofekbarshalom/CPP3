...
TEST_CASE("Game class tests") {
    ...
    // Initialize tests
    // -----------------------------------------
    // Verify all players are added and first turn is correct
    SUBCASE("Initial player list and order") {
        CHECK(game.players().size() == 6);
        CHECK(game.turn() == "Governor");
    }

    // Ensure all players start with 0 coins
    ...
    // turn() tests
    // -----------------------------------------
    // turn() should throw if no players are added
    ...
    // advanceTurn should skip dead players
    ...
    // advanceTurn should throw if everyone is dead
    ...
    // addPlayer() tests
    // -----------------------------------------
    // No more than 6 players can join the game
    ...
    // removePlayer() tests
    // -----------------------------------------
    // removePlayer() should mark player as dead
    ...
    // players() test
    // ---------------------------------------------------
    // players() should return only names of alive players
    ...
    // getPlayers() test
    // --------------------------------------------------------------
    // getPlayers() should return all Player pointers, even dead ones
    ...
    // winner() tests
    // --------------------------------------------------------
    // If only one player is alive, winner() should return them
    ...
    // winner() should throw if more than one player is alive
...
TEST_CASE("Player class tests") {
    ...
    // Basic checks after Player is created
    ...
    // Check that requireMyTurnAndAlive throws appropriately
    ...
    // gather() tests
    // ----------------------------------------------
    // gather() should increase coins and change turn
    ...
    // bribe() tests
    // --------------------------------------------------
    // bribe should deduct coins and let player act again
    ...
    // arrest() tests
    // --------------------------------------
    // arrest should transfer coins correctly
    ...
    // sanction() tests
    // ---------------------------------------------
    // sanction should block target's income actions
    ...
    // coup() tests
    // ---------------------------------------------
    // coup should eliminate target and cost 7 coins
...
TEST_CASE("Governor behavior") {
    ...
    // Tax bonus test
    // -----------------------------------------
    // Governor gets 3 coins instead of 2 on tax
